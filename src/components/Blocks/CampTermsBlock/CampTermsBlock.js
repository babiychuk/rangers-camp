            ...
            <Row className="m0-5 terms-block">
                <Col md="2" xs="6" className="t-center">
                    <div className="">
                        ...
                        <p className="terms_text">цілодобова охорона та відеонагляд</p>
                    </div>
                </Col>
                <Col md="2" xs="6" className="t-center">
                    <div className="">
                        ...
                        <p className="terms_text">6-ти разове харчування</p>
                    </div>
                </Col>
                <Col md="2" xs="6" className="t-center">
                    <div className="">
                        ...
                        <p className="terms_text">у дерев’яних будиночках</p>
                    </div>
                </Col>
                <Col md="2" xs="6" className="t-center">
                    <div className="">
                        ...
                        <p className="terms_text">Зона чистоти біля будиночків</p>
                    </div>
                </Col>
                <Col md="2" xs="6" className="t-center">
                    <div className="">
                        ...
                        <p className="terms_text">басейн, озеро та екстрим парк</p>
                    </div>
                </Col>
                <Col md="2" xs="6" className="t-center">
                    <div className="">
                        ...
                        <p className="terms_text">всебічний розвиток особистості кожної дитини</p>
                    </div>
                </Col>
            </Row>
        );
